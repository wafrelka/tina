...
fn it_should_format_cancel_eew()
{
	...
	let result = ja_format_eew_short(&eew);
...
#[test]
fn it_should_format_normal_eew_01()
{
	let eew = EEW {
		source: Source::Tokyo,
		kind: Kind::Normal,
	...
	let expected = "[予報] 宮城県沖 震度4 M5.9 10km (N38.0/E142.0) 12:28:49発生 / 第1報 ND20130804122902";
...
#[test]
fn it_should_format_normal_eew_02()
{
	let eew = EEW {
		source: Source::Tokyo,
		kind: Kind::Normal,
